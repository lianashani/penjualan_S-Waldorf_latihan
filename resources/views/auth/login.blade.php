    ...
    <div class="login-wrapper">
        ...
        <div class="login-form-section">
            ...
            <div class="logo-section">
                <div class="logo text-center">
                    ...
                    <span class="badge badge-primary badge-pill">Admin & Kasir Login</span>
                    <p class="mt-3"><small>Member? <a href="{{ route('member.login') }}">Login disini</a></small></p>
                </div>
            </div>
        ...
        <div class="login-image-section">
            <div class="illustration-content">
                ...
                <h2>Sistem Manajemen<br>S&Waldorf Store</h2>
